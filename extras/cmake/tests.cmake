...
# Legacy OpenGL graphics examples
if(EXTERNAL_SHLIBS_GRAPHICS_OPENGL)
    extempore_add_example_as_test(examples/contrib/gl-compatibility.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/openvg.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/raymarcher.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/spectrogram.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/xtmrender1.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/xtmrender2.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/xtmrender3.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/xtmrender4.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/arrows.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/framebuffer.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/heatmap.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/particles.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/points.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/shadertoy.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/simple-triangle.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/texture.xtm 10 examples-graphics-opengl)
    extempore_add_example_as_test(examples/contrib/shader-tutorials/triangle.xtm 10 examples-graphics-opengl)
endif()
